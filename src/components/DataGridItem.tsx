...
export const DataGridItem: React.FC<DataGridItemProps> = ({ label, value, icon }) => (
  <div className="bg-slate-900/40 rounded-xl border border-slate-800/60 p-4 flex flex-col gap-2 hover:bg-slate-800/60 hover:border-teal-500/30 transition-all duration-300 backdrop-blur-sm group h-full">
